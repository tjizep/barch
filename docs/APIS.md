...
1. `B.ADD K V` add a key and value [more](https://tjizep.github.io/barch/ADD)
2. `B.SET K V` set a key overriding existing value [more](https://tjizep.github.io/barch/SET)
3. `B.GET K` retrieve a key, returns nil if no key exists [more](https://tjizep.github.io/barch/GET)
...
14. `B.KEYS` scan keys with a glob pattern without blocking other calls [more](https://tjizep.github.io/barch/KEYS)
15. `B.VALUES` scan values with a glob pattern without blocking other calls [more](https://tjizep.github.io/barch/KEYS)
15. `ACL` and `AUTH` [more](https://tjizep.github.io/barch/ACL)
