...
alignas(Alignment) std::atomic<uint64_t> statistics::files_evicted = 0;
...
alignas(Alignment) std::atomic<uint64_t> statistics::luau_bytes = 0;
alignas(Alignment) std::atomic<uint64_t> statistics::luau_states = 0;
alignas(Alignment) std::atomic<uint64_t> statistics::luau_functions = 0;
alignas(Alignment) std::atomic<uint64_t> statistics::luau_native_compiled = 0;
