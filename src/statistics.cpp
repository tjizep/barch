...
std::atomic<uint64_t> statistics::read_locks_active;
std::atomic<uint64_t> statistics::write_locks_active;
...
std::atomic<uint64_t> statistics::bytes_in_free_lists = 0;
...
namespace statistics::repl {
    ...
    std::atomic<uint64_t> barch_requests = 0;
