...
public:
    ...
    Value incr(const std::string& key, long long by);
    Value incr(const std::string& key);
    Value decr(const std::string& key, double by);
    Value decr(const std::string& key, long long by);
    Value decr(const std::string& key);
    Value erase(const std::string &key);
    long long ttl(const std::string &key);
    bool exists(const std::string &key);
    bool expire(const std::string &key, long long sec, const std::string& flag = "");
    std::vector<Value> glob(const std::string& glob, long long max_ = 0) const;
