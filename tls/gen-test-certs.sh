...
#   /tls/valkey.{crt,key}      A certificate with no key usage/policy restrictions.
...
openssl req \
    ...
    -key tls/ca.key \
    -days 3650 \
    -subj '/O=Barch Test/CN=Certificate Authority' \
    -out tls/ca.crt
...
[ -f tls/valkey.dh ] || openssl dhparam -out tls/valkey.dh 2048
